...
public abstract class BiometricsActivity extends BaseActivity implements EnrollmentDialogFragment.EnrollmentDialogListener, SubjectListFragment.SubjectSelectionListener, LicensingManager.LicensingStateCallback {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		try {
			...
			setContentView(R.layout.multimodal_main_biometric_latest);
